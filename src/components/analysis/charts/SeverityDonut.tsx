...
export const buildSeverityDonutOptions = (data: NormalizedReport): ChartOption => {
  const { error, warning, advice } = data.distribution.severity;
...
export const SeverityDonut: Component = () => {
  ...
  return <ChartBase options={buildSeverityDonutOptions(context.data)} />;
};
